...
function Wisp(game, AM, x, y) {
    ...
    var wispRight = new Animation(AM.getAsset("./img/enemy/wisp.png"), 44, 50, 0.1, true);
    wispRight.addFrame(44, 0, 4);
    var wispLeft = new Animation(AM.getAsset("./img/enemy/wisp.png"), 44, 50, 0.1, true);
